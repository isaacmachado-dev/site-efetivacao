    ...
    return (
        <SectionReveal className="flex flex-col mt-100 gap-2">
            ...
            <div className="text-sm text-center">
                Como a nossa permanência como efetivos é só vantagem.
            </div>
            ...
            <div className="mt-20 flex flex-col md:flex-row gap-8 max-w-[1280px] w-full mx-auto">
                ...
                <div className="flex-1 flex flex-col gap-4 bg-white/5 rounded-[20px] p-8">
                    ...
                    <span className="text-sm text-zinc-400">
                        Ainda sim, problemas acontecem. Mas com dedicação total, a triagem e a resolução dos chamados urgentes passam a ser instantâneas.
                    </span>
                </div>
