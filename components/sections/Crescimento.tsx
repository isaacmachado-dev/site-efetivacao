...
export function Crescimento() {
    ...
    return (
        <>
           <SectionReveal className="mt-100 flex flex-col  gap-3 items-center mb-20">
                <div 
                    id="crescimento"
                    className="text-center text-brand-accent uppercase font-mono mb-5 text-sm font-semibold"
                >
