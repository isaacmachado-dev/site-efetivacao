...
export function Crescimento() {
    ...
    return (
        <>
            <div className="flex flex-col mt-100 gap-3 items-center">
            ...
            <div className="mt-50 flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-6 max-w-[500px] mx-auto">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <div className={`transition-all duration-500 flex-1 flex flex-col gap-2 rounded-2xl p-6 ${efetivacao ? 'border border-brand-main/30 bg-brand-main/10 scale-105 text-[#c084fc]' : 'border border-transparent bg-white/5 text-zinc-400'}`}>
                    ...
                    <button 
                        ...
                        className={`flex flex-row items-center justify-between   transition-colors duration-200 rounded-2xl p-4 cursor-pointer ${efetivacao ? 'bg-brand-main/10 border border-brand-main/30 scale-105' : 'bg-white/5 border border-transparent hover:bg-white/10'}`}
                    >
                        ...
                        <div 
                            className={`w-16 h-9 rounded-full p-1 flex items-center transition-colors duration-300 ease-in-out ${
